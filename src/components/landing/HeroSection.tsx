    ...
    >
      <div className="space-y-4 mt-10 md:mt-20">
        ...
        <p className="text-lg md:text-xl text-light-text dark:text-dark-text">
          Create a culture of honest communication and continuous improvement
          with our anonymous feedback platform.
        </p>
        <div className="flex flex-col md:flex-row gap-4">
          <Link
            href="/login"
            className="px-6 py-3 md:px-8 md:py-4 bg-light-highlight dark:bg-dark-highlight rounded-lg text-light-text dark:text-dark-text font-semibold text-lg shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
          >
            Start Collecting Feedbacks
          </Link>
          <Link
            href="/about-us"
            className="px-6 py-3 md:px-8 md:py-4 border-2 border-light-highlight dark:border-dark-highlight text-light-highlight dark:text-dark-highlight rounded-lg font-semibold text-lg shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
          >
            How It Works
          </Link>
        </div>
