...
const inputVariants = cva(
  "flex w-full rounded-lg border bg-light-background dark:bg-dark-secondary text-light-text dark:text-dark-text transition-all duration-200 file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-light-muted-text dark:placeholder:text-dark-noisy-text focus:outline-none disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "border-light-secondary dark:border-dark-secondary focus:ring-2 focus:ring-primary-main/20 focus:border-primary-main dark:focus:border-primary-light dark:focus:ring-primary-main/20",
        error:
