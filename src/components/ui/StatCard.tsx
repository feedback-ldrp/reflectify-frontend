  ...
  return (
    <Card
      ...
      className={clsx(
        ...
        {
          "cursor-pointer group hover:shadow-md hover:border-primary-main/50":
            isClickable,
          "hover:bg-light-muted-background dark:hover:bg-dark-hover":
            isClickable,
        },
        className,
      )}
    ...
    >
      ...
      <div className="p-3 flex justify-between items-start gap-4">
        ...
        <Icon className="h-14 w-14 text-primary-main/70 group-hover:text-primary-main transition-all duration-300 group-hover:scale-110 flex-shrink-0" />{" "}
