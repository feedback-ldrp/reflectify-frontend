...
export default function EditFeedbackFormPage({
  ...
  const [awaitingSecondConfirmation, setAwaitingSecondConfirmation] = useState<
    string | null
  >(null);
  ...
  const fetchDropdownData = useCallback(async () => {
    try {
      const [facultiesData, subjectsData, categoriesData] = await Promise.all([
  ...
  const handleStatusUpdate = async () => {
    ...
    setSaving(true);
    try {
      const updatedForm = await feedbackFormService.updateFormStatus(formId, {
  ...
  const handleQuestionDelete = async (questionId: string) => {
    ...
    try {
      await feedbackQuestionService.softDeleteFeedbackQuestion(questionId);
        ...
        >
          ...
          >
            ...
            <div className="p-1">
                            ...
                            <div>
                              ...
                              <Select
                                ...
                                onChange={(e) =>
                                  handleFormUpdate(
                                    "status",
                                    e.target.value as FeedbackFormStatus,
                                  )
                                }
                                aria-label="Form Status"
                              >
                                <option value={FeedbackFormStatus.DRAFT}>
                                  Draft
                                </option>
                          ...
                          <div className="flex justify-center items-start">
                            <div className="w-full">
                              <label className="block text-md font-medium text-light-text dark:text-dark-text mb-2">
                                Select Form Dates (Optional)
                              </label>
                              <DateRangePicker
                                initialStartDate={editedForm?.startDate}
                                initialEndDate={editedForm?.endDate}
              ...
              <TabsContent value="Form Students" className="space-y-6">
                <div className="space-y-6">
                  ...
                  {!canModifyQuestions && (
                    <div className="mt-4 p-3 rounded-lg bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800">
                      <p className="text-md text-yellow-800 dark:text-yellow-300">
                        ...
                        Questions can only be modified when the form is in DRAFT
                        status.
                      </p>
                    </div>
                  )}
                ...
                <Card className="p-6 bg-light-background dark:bg-dark-muted-background">
                  <div className="flex items-center justify-between mb-6">
                    <h2 className="text-xl font-semibold text-light-text dark:text-dark-text">
                      Questions ({editedForm.questions?.length || 0})
                    </h2>
                  </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            ...
                            <Select
                              ...
                              disabled={loadingDropdowns || !canModifyQuestions}
                            >
                  ...
                  {/* Questions List */}
                  {editedForm.questions && editedForm.questions.length > 0 ? (
                    <div className="space-y-4">
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <button
                                type="button"
                                title={
                                  awaitingSecondConfirmation === question.id
                                    ? "Are you sure?"
                                    : "Delete Question"
                                }
                                onClick={() => {
                                  if (
                                    ...
                                    setAwaitingSecondConfirmation(null);
                                  } else {
                                    setAwaitingSecondConfirmation(question.id);
                                    setTimeout(() => {
                                      setAwaitingSecondConfirmation(null);
                                    }, 5000);
                                  }
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              ...
                              <div>
                                ...
                                <Select
                                  ...
                                  disabled={
                                    loadingDropdowns || !canModifyQuestions
                                  }
